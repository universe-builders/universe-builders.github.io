...
This document contains the funding opportunities and finance plan for Void Survivors. Contained are two budgets, an optimistic budget based on the ability to recieve funding for all milestones at the current scope, and a budget based on a reduced game scope.

----

## Grant Funding Opportunities

This project is eligable for grants from various organizations. Including the following:
...
Void Survivors is an attractive game for publishers due it it's relatively low development and live operations cost, and it's opportunity to go viral.

There are dozens of appropriate publishers for Void Survivors. The best fit is web platform publishers, as they are reportadely underserviced. Publishers such as Armor Games and Kongregate frequently publish games that are distributed by their platform, usually with an exclusivity period.
...
This is not an ideal option due to the cost of preparing for and running the crowd funding campaign. It will not be considered unless all other funding options have been not come to fruition.
...
This content could instead be developed in early access or live service, instead of in the Alpha and Beta milestones, based on funding recieved from monetizing the game.
